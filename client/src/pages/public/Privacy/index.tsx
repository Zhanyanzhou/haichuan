...
const SECTIONS = [
  ...
  {
    title: "行为分析",
    body: "在独立的隐私偏好与用户授权机制完成之前，本站默认关闭行为分析：不生成匿名会话标识，也不向服务器发送页面访问或点击事件。分析相关代码以安全方式保留，关闭状态下不会采集您的浏览行为。分析功能未来如开启，我们会提前更新本说明。",
  },
  {
    title: "信息保存",
    items: [
  ...
  {
    title: "本地存储",
    body: "网站在您的浏览器中保存登录令牌与本地选款清单，用于保持登录状态和跨页面选款。这些数据保存在您的设备上，您可以在浏览器设置中随时清除。关闭行为分析后，我们不写入用于追踪的匿名会话标识。",
  },
  {
    title: "未成年人",
    ...
    <div style={{ background: T.bg }}>
      ...
      <section style={{ paddingBlock: "clamp(28px,4vh,48px)" }}>
        <div style={{ maxWidth: 760, marginInline: "auto", paddingInline: PX }}>
          ...
          >
            本说明最后更新于 2026-08-13。如本说明与实际代码行为不一致，以实际代码行为为准；我们会及时更新本说明。
          </p>
        </div>
      </section>
    </div>
