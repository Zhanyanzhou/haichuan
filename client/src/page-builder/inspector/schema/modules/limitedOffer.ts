/**
 * schema/modules/limitedOffer.ts — 「限时活动(限时礼遇)」编辑区 Schema。
  ...
  sections: [
    {
      ...
      fields: [
        moduleNameField("限时礼遇"),
        { key: "eyebrow", label: "眉题", control: "text", maxLength: 60, placeholder: "如 CAMPAIGN" },
        {
          key: "title",
          label: "活动标题",
          control: "text",
        ...
        { key: "linkUrl", label: "按钮链接", control: "text", hint: "站内路径" },
      ],
    },
    {
