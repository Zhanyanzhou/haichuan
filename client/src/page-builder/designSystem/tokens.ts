 ...
 *   旧字面值仅作为 fallback 保留。
 * - 比例调色板 5 档(2026-08-19 收敛),权威来源是内容模板契约;RATIOS 仅为设计令牌别名,不允许新造比例值。
 */
...
/* ═══ 规范图片比例(唯一合法集合,不要新增) ═══ */
export const RATIOS = {
  // 2026-08-19 调色板收敛 8→5:16:7 / 3:4 / 2:3 撤编(旧数据由渲染层兼容渲染);
  // 21:9 已于 2026-08-16 清退。权威默认值以契约 roles[].defaultRatioByViewport 为准。
  "21:6": "21 / 6",
  "16:9": "16 / 9",
  "3:2": "3 / 2",
  "4:5": "4 / 5",
