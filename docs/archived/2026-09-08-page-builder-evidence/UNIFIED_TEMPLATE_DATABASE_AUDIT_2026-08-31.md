...
> **数据库审计准备记录（2026-08-31）**：当轮状态为代码准备完成、目标数据库未连接、migration 未执行、生产未切换；不能据此推断今天任何目标环境的状态。下文脚本、数量和 Gate 分类保留当时背景，使用前按当前代码与精确环境重新核验。现行资料见[文档导航](../../page-builder/README.md)。
