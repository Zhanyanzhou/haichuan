...
> [!CAUTION]
> **2026-08-06 历史路线图，现已失效，禁止按批次或命令执行。** 下文优先级、完成状态、文件范围与验收口径仅作历史证据，不代表当前计划。当前权限只认 `AGENTS.md` / `WORKFLOW.md`；当前状态查 `docs/CURRENT_STATE.md`，实施范围与验收必须基于当前工作树和新鲜证据重新确定。
